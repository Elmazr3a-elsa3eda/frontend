			...
			<div className="lg:grid lg:min-h-screen lg:grid-cols-12">
						...
						>
							<div className="col-span-6">
								...
								<input
									...
									className="p-2 mt-1 w-full rounded-md border-gray-500  border-[1px] bg-white text-sm text-gray-700 shadow-md"
                ...
                {isSubmitted && errors.role && <p className="text-red-500 text-xs">{errors.role}</p>}
							...
							<div className="col-span-6 sm:flex sm:items-center sm:gap-4">
								<button onClick={(e)=>handleSubmit(e)} className="inline-block shrink-0 rounded-md border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500">
									Create an account
								</button>
