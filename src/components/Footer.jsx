...
function Footer() {
  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="text-center">
      <h2 className="text-3xl font-extrabold text-gray-900 sm:text-5xl">keep in controll of every detail</h2>

      <p className="mx-auto mt-4 max-w-sm text-gray-500">
        your farm is your business, keep track of every detail and make the best decisions for your
      </p>
    ...
    >
      <ul className="flex flex-wrap justify-center gap-4 text-lg lg:justify-end">
        ...
        <li>
          <a href="#" className="text-gray-500 transition hover:opacity-75 font-honk">happy Farm</a>
        </li>
      </ul>
