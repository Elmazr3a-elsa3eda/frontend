...
function SideNav() {
	...
	return (
		<>
			<div className="w-full max-w-[133px] h-full min-h-[500px] max-h-[500px] px-5 pt-10 pb-5 flex flex-col justify-center items-center bg-darkerblue z-20 rounded-[20px]">
